using HelpFullUi.Client.Shared.Shared;
#if BlazorServer
...
namespace HelpFullUi.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("HelpFullUi.Client.Shared.wwwroot.appsettings.json"));
