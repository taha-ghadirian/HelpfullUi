...
using HelpFullUi.Server.Api.Models.Emailing;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("HelpFullUi.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("HelpFullUi.Server.Api.Resources.ResetPassword.cshtml",
